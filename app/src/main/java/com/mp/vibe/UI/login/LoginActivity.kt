...
class LoginActivity : AppCompatActivity() {
    ...
    private lateinit var myProgressBar: LinearLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val access_tokens = localDB.authResponseDao().all;
        ...
        myProgressBar = findViewById<LinearLayout>(R.id.includeProgressBar)
